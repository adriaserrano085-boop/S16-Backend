...
class Entrenamientos(Base):
    ...
    id_entrenamiento = Column(String, primary_key=True, default=lambda: str(uuid.uuid4()))
...
class Rivales(Base):
    ...
    id_equipo = Column(String, primary_key=True, default=lambda: str(uuid.uuid4()))
...
class JugadorFamilia(Base):
    ...
    updated_at = Column(DateTime(timezone=True))
    id_jugador_hospi = Column(String, primary_key=True, default=lambda: str(uuid.uuid4()))
    id_familia = Column(String)
    id = Column(String)
